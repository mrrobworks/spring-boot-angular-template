...
```bash
$ ./mvnw clean install -Dgoogle.client.id=[google-client-id] -Dgoogle.client.secret=[google-client-secret] -Dgithub.client.id=[github-client-id] -Dgithub.client.secret=[github-client-secret]
```
